...
// ── Doctor data ──────────────────────────────────────────────────────────────
// Replace the calendlyUrl values with your actual Calendly event URLs.
// Format: https://calendly.com/{your-account}/{event-type}
interface Doctor {
  id: string;
  name: string;
  specialty: string;
  filterTags: string[]; // for matching the filter chips
  years: number;
