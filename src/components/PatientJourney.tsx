    ...
    <section className="relative w-full min-h-[100vh] flex flex-col font-manrope overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          ...
          {/* Fallback image if the video fails to load or browser doesn't support video */}
          <img 
            src="./jahaz.jpg" 
            alt="Medical Journey Background" 
            className="w-full h-full object-cover" 
        ...
        {/* Dark Overlay - No blur, just a slight tint to keep white text readable */}
        <div className="absolute inset-0 bg-black/20" />
      </div>

      {/* 2. MAIN CONTENT CONTAINER - Pinned Tighter to Top Left */}
      {/* Reduced padding-top (pt-8 md:pt-12) to shift text higher up */}
      <div className="relative z-10 w-full h-full flex-grow flex flex-col justify-start items-start pt-8 md:pt-12 px-6 lg:px-16 max-w-[100rem] mx-auto pointer-events-none">
        
        {/* --- TOP LEFT: TITLE --- */}
        <div className="text-left opacity-0 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-light font-manrope text-white tracking-tighter drop-shadow-2xl">
            The Journey
          </h2>
        </div>
